...
def E(d,o,w,z)l=d[0];h=d[2];a=z-h-2;c=a-w-1;e=o+l+w+2;f=o+w;r=l+f+4;C(z-1,o,l,0);C(a,o,l,0);C(c,f+1,l,0);C(o,a,h,1,o>0);C(o+l+1,a,h,1);C(e,c,h,1);C(f+1,c,w,2,o>0);C(e,c,w,2);C(e,$u,w,2);r;end
w=f[0][1]
n=f.size
